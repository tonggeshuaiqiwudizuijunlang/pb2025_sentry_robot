...
def launch_setup(context: LaunchContext) -> list:
    ...
    bringup_cmd_group = GroupAction(
        [
            # robot_state_publisher must start FIRST to publish robot_description
            Node(
            ...
            # joint_state_publisher starts after robot_state_publisher
            Node(
...
def generate_launch_description():
    ...
    # pb2025_infantry_robot  pb2025_sentry_robot  simulation_robot yq2026_shaobing_robot
