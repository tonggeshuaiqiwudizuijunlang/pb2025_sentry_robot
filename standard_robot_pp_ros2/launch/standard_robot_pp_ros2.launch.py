...
sys.path.append(os.path.join(get_package_share_directory('standard_robot_pp_ros2'), 'launch'))

def generate_launch_description():
    launch_params = yaml.safe_load(open(os.path.join(
        get_package_share_directory('standard_robot_pp_ros2'), 'config', 'launch_params.yaml')))

    robot_gimbal_description = Command(['xacro ', os.path.join(
        get_package_share_directory('standard_robot_pp_ros2'), 'urdf', 'rm_gimbal.urdf.xacro'),
    ...
    declare_robot_name_cmd = DeclareLaunchArgument(
        "robot_name",
        default_value="yq2026_shaobing_robot",
